...
Editorial-style desktop app scaffold for the Forma OCR-to-Excel workflow.
...
This is an alternate design workspace:

- canonical parser registry
- document type detection
- settings storage
- extraction service wrapper
- frontend shell with `app-clean`-inspired visual language
